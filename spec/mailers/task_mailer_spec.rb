...
describe TaskMailer, type: :mailer do
  let(:task) { FactoryBot.create(:task, name: 'Mailer Specを書く', description: '送信した内容を確認します') }
